...
console.log(`5. WAP to print a table  5 like 5 10 15 20 25....50`);
for (let index = 5; index <=50; index=index+5) {
    console.log( index);
        
    }
console.log(`6. WAP to print a table 10 like 10 20 30 40....100 `);
for (let index = 10; index <=100; index=index+10) {
    console.log( index);
        
    }
console.log(`7. WAP to print a table 10 in reverse order like 100 90 80 70.....10 `);
